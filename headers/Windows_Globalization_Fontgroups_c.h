// Flat C exports observed in Windows.Globalization.Fontgroups.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef WINDOWS_GLOBALIZATION_FONTGROUPS_C_H
#define WINDOWS_GLOBALIZATION_FONTGROUPS_C_H
...
// Export: GetPreferredFont (ABI unverified)

#ifdef __cplusplus
} // extern "C"
#endif
#endif // WINDOWS_GLOBALIZATION_FONTGROUPS_C_H
