...
static constexpr wchar_t module_name[37] = {0x0057, 0x0069, 0x006E, 0x0064, 0x006F, 0x0077, 0x0073, 0x002E, 0x0047, 0x006C, 0x006F, 0x0062, 0x0061, 0x006C, 0x0069, 0x007A, 0x0061, 0x0074, 0x0069, 0x006F, 0x006E, 0x002E, 0x0046, 0x006F, 0x006E, 0x0074, 0x0067, 0x0072, 0x006F, 0x0075, 0x0070, 0x0073, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2401575024U || rva >= image_size) return nullptr;
return base + rva;
}
