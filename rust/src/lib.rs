//! Windissect-generated Rust FFI bindings for Windows.Globalization.Fontgroups.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "F229BCF467217B70B1914FE0719AB172";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2401575024;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 37] = [87, 105, 110, 100, 111, 119, 115, 46, 71, 108, 111, 98, 97, 108, 105, 122, 97, 116, 105, 111, 110, 46, 70, 111, 110, 116, 103, 114, 111, 117, 112, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2401575024 { return 0; }
